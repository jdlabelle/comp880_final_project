...
def test_most_physical_defensive_pair():
    """
    Test happy path of most_physical_defensive_pair() method in Lines. Return a dictionary with key `team` and value
     `name` with the highest hits statistic for that team. Will only return defensive pairs; offensive lines are
     filtered out.
    """
    ...
    expected_result = {"OTT": "Chabot-Brannstrom", "DET": "Chiarot-Seider", "PIT": "Dumoulin-Letang",
                       "COL": "Girard-Makar"}
